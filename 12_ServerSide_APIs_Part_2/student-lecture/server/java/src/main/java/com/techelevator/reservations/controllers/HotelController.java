...
public class HotelController {
    ...
    public Reservation updateReservation(@Valid @RequestBody Reservation updatedReservation, @PathVariable("id") int reservationID)
            throws ReservationNotFoundException {
        return reservationDAO.update(updatedReservation, reservationID);
    }
    ...
    @RequestMapping (path = "reservations/{id]", method = RequestMethod.PUT)
    public void deleteReservation(@PathVariable Reservation deleteReservation, @PathVariable());
